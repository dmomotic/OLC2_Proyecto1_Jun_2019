    ...
    public Object getValor(Entorno e) {
        ...
        if(s!=null)
        {
            if(s.tipo.isDouble()){
                ...
                System.out.println("Error!! No se puede realizar el incremento a la variable: " + id.valor + " de tipo: " 
                        + s.tipo.get() + " en la linea: " + linea);
            }
        }
        else
        {
            System.out.println("Error!! no se puede realizar el incremento porque no se encontro el id: " + id.valor 
                    + " en la linea: " + linea);
        }
        return null;
    }
